...
/* official 3D logo */
const Logo = ({ size = "md" }) =>
<a href="#top" className={`logo logo--${size}`} aria-label="Cascob">
    <img className="logo__img" src="img/logo-cascob.png" alt="Cascob" style={{ objectFit: "fill", padding: "3px 0px 0px" }} />
...
/* big floating logo for hero */
const HeroLogo = () =>
<div className="hero-logo" aria-hidden="true">
    <img src="img/logo-cascob.png" alt="" style={{ objectFit: "scale-down", width: "200px", borderColor: "rgb(255, 255, 255)", borderStyle: "none", borderWidth: "0px", borderRadius: "0px" }} />
  </div>;
    ...
    <section className="hero" id="top">
      <div className="hero__grid">
        <div className="hero__left">
          <span className="eyebrow"><span className="eyebrow__line" /> desde 2012 · são josé do rio preto · sp</span>
...
function Strip() {
  ...
  return (
    <div className="strip" aria-hidden="true">
      <div className="strip__track">{row}{row}</div>
    </div>);
    ...
    <section className="section section--cream-deep" id="servicos">
      <div className="container">
        <div className="section__head">
          ...
          <h2 className="h2">Tudo o que pode estar <em>sujando seu nome.</em></h2>
    ...
    <section className="section section--black" id="como-funciona">
      <div className="container">
        <div className="section__head">
          ...
          <h2 className="h2 h2--light">Quatro passos. <em>Sem promessa milagrosa.</em></h2>
        </div>
        <ol className="steps">
          {STEPS.map((s, i) =>
...
function App() {
  ...
  useEffect(() => {document.documentElement.dataset.mode = t.mode;}, [t.mode]);
  return (
    <>
      <Header />
      <main>
